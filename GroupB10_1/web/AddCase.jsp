...
<html lang="en">
    ...
    <body>
        <%
            /*String Cas_ID = request.getParameter("Case_ID");
             int Case_ID = Integer.parseInt(Cas_ID);
             String Cli_ID = request.getParameter("Client_ID");
             int Client_ID = Integer.parseInt(Cli_ID);*/
            ...
            int AddCase = connection.AddCase(Case_ID, Client_ID, Title, Category, Status, Fees);
            if (AddCase > 0) {
